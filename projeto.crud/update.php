...
if (!empty($_POST)) {
    ...
    if (empty($data_dc)) {
        $data_dcErro = 'Por favor digite a data de pagamento!';
        $validacao = false;
    } else if (!filter_var($data_dc, FILTER_VALIDATE_data_dc)) {
        $data_dcErro = 'Por favor digite uma data de pagamento válida!';
        $validacao = false;
    }
    ...
    if ($validacao) {
        ...
        $sql = "UPDATE pessoa  set nome = ?, endereco = ?, telefone = ?, email = ?, data_dc = ?,sexo = ? WHERE id = ?";
        $q = $pdo->prepare($sql);
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="update.php?id=<?php echo $id ?>" method="post">
                    ...
                    <div class="control-group <?php echo !empty($data_dcErro) ? 'error' : ''; ?>">
                        <label class="control-label">Data de cadastro</label>
                        <div class="controls">
                            <input name="data_dc" class="form-control" size="50" type="text" placeholder="Data"
                                   value="<?php echo !empty($data_dc) ? $data_dc : ''; ?>">
                            <?php if (!empty(data_dcErro)): ?>
                                <span class="text-danger"><?php echo $data_dcErro; ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
